export const letterA = [
  ...
  {
    id: 8,
    title: "Acceptance of Quotations",
    subtitle:
...
export const letterI = [
  ...
  },
  {
    ...
    subtitle:
      "Track goods and inventory levels across the supply chain of your business with inventory management software. The software gives you the update on the product journey right from the order placements to its delivery to your customers",
  },
  {
    id: 4,
    title: "Invoices",
...
export const letterS = [
  ...
  },
  {
    ...
    subtitle:
      "Keep a complete track record of your stock with an end-to-end tracking system that helps you track the movement of each item right from the warehouse to the salespoint",
  },
  {
    id: 3,
    title: "Support",
